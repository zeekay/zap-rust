...
You need the ZAP compiler (`capnp`) installed on your system. This compiles `.capnp` schema files into a binary format that the Rust code generator reads.
